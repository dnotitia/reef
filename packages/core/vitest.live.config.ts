 ...
 * the always-green unit signal. Invoked by `pnpm test:live-akb` when an externally
 * prepared endpoint is available; each spec self-skips unless
 * REEF_LIVE_AKB_URL points at a reachable akb.
 */
