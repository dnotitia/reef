...
export {
  ...
  ReleaseRuntimeImagesSchema,
  ReleaseRegistrationResultSchema,
  ...
  type ReleaseRuntimeImages,
  type ReleaseRegistrationResult,
  type ControlPlaneRolloutStep,
  type ControlPlaneRolloutTarget,
  type ControlPlaneRolloutStatus,
