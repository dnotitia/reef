...
export const JiraIssueFieldResultSchema = z.strictObject({
...
export const JiraIssueDeferredItemSchema = z.strictObject({
  kind: z.enum([
    "parent",
    "relation",
    "release",
...
export const JiraPlanningAssociationSchema = z.strictObject({
...
export const JiraIssueImportPlanSchema = z.strictObject({
  ...
  raw_preservation: z.strictObject({
