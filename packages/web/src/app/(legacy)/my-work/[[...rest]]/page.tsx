...
/**
 * Backward-compat shim for the pre-REEF-315 flat `/my-work` URLs (and any
 * sub-path). The optional catch-all matches the whole segment; LegacyRedirect
 * forwards to the vault-scoped `/workspace/{vault}/my-work` route, preserving the
...
export default function LegacyMyWorkPage() {
