  ...
  return (
    <DropdownMenu className={inSidebar ? "w-full" : undefined}>
      <DropdownMenuTrigger
        ...
        className={cn(
          "min-h-11 gap-2 rounded-md text-left [touch-action:manipulation] transition-colors hover:bg-surface-hover aria-expanded:bg-surface-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-focus",
          inSidebar
            ? cn(
                "w-full",
      ...
      >
        <div className="flex items-center gap-2 px-2 py-1.5">
          ...
          <span className="flex min-w-0 flex-col">
            <span className="type-navigation truncate font-medium text-foreground">
              {identity.name}
            </span>
            {identity.email && (
              <span className="type-card-metadata truncate text-muted-foreground">
        ...
        <p
          aria-live="polite"
          className="px-2 type-card-metadata text-destructive-text empty:hidden"
        >
        ...
        <DropdownMenuItem asChild className="min-h-11">
          ...
          >
            ...
            <span className="flex items-center gap-1 type-compact-mono text-muted-foreground">
