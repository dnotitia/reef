 ...
 *   2. persists the URL vault as the per-browser "last viewed" default ONLY once
 *      membership is confirmed (a denied deep link must not poison the default),
...
export function WorkspaceGuard({ appVersion, children }: WorkspaceGuardProps) {
  ...
  // the browser default, after which `/` and the legacy shim would keep
