        ...
        {field === "labels" && (
          <Popover open onOpenChange={closeOpenField}>
            <PopoverTrigger
              ...
              disabled={issuePending}
              className="h-8 w-full justify-start rounded-md border border-border bg-surface-popover px-2.5 type-control text-foreground shadow-lg shadow-foreground/10"
            >
              {fieldNames.labels}
              {fieldPending && (
                <LoaderCircle
