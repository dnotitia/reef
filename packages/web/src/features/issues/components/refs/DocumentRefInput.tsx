...
const INPUT_CLASS =
  "flex h-8 w-full min-w-0 rounded-md border border-border bg-surface-elevated pl-8 pr-8 py-1 type-control text-foreground transition-colors duration-150 placeholder:text-muted-foreground focus:outline-none focus:border-brand-focus focus:ring-2 focus:ring-inset focus:ring-brand-focus disabled:opacity-50";
