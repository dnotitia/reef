...
const INPUT_CLASS =
  "flex h-8 flex-1 min-w-0 rounded-md border border-border bg-surface-elevated px-2.5 py-1 type-control text-foreground transition-colors duration-150 placeholder:text-muted-foreground focus:outline-none focus:border-brand-focus focus:ring-2 focus:ring-inset focus:ring-brand-focus disabled:opacity-50";
      ...
      {!isSingle &&
        (value.length > 0 ? (
          ...
          <p
            ...
            className="rounded-md border border-dashed border-border-subtle bg-surface-subtle px-2 py-2 type-caption text-muted-foreground"
          >
            {t("emptyRelation")}
          </p>
        ) : null)}
    ...
    <li className="flex items-center gap-1">
      <div className="flex min-w-0 flex-1 items-center gap-1">
        ...
        <button
          ...
          className="shrink-0 touch-manipulation rounded-md p-1 text-muted-foreground transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-focus disabled:opacity-50"
        >
