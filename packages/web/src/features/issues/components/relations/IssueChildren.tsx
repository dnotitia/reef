  ...
  return (
    ...
    >
      <Link
        ...
        className="flex min-w-0 flex-1 touch-manipulation items-center gap-2 rounded-md px-1.5 py-1 transition-colors duration-150 @max-[40rem]:basis-full @max-[40rem]:flex-wrap focus-visible:relative focus-visible:z-10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-focus"
      >
        <Tooltip
      ...
      >
        <TooltipTrigger asChild>
          <button
            ...
            className="flex w-32 shrink-0 items-center justify-start rounded-md border-0 bg-transparent p-0 text-sm @max-[40rem]:ml-auto focus-visible:relative focus-visible:z-10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-focus"
          >
            <PersonChip
