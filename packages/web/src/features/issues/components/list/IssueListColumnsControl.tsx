...
export function IssueListColumnsControl({
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        className="h-8 gap-1.5 rounded-md border border-border bg-surface-elevated px-2.5 type-control text-muted-foreground transition-colors duration-150 hover:bg-surface-hover hover:text-foreground"
