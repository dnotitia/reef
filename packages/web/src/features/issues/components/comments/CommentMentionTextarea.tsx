  ...
  return (
    <>
        ...
        >
          {mentionSuggestions.map((member, index) => (
            <button
              ...
              className="flex w-full items-center gap-2 px-2 py-1.5 text-left type-control text-foreground hover:bg-muted aria-selected:bg-muted"
      ...
      {(uploading || uploadError) && (
        <div
          className="px-3 pb-1 type-card-metadata text-muted-foreground"
