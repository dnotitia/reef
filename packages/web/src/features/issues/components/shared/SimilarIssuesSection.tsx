    ...
    >
      ...
      <div className="grid grid-cols-[minmax(0,1fr)_1.25rem] items-center gap-2">
        ...
        <button
          ...
          className="inline-flex size-5 shrink-0 touch-manipulation items-center justify-center rounded-sm text-muted-foreground hover:bg-muted hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-focus"
          onClick={() =>
          ...
          {issues.map((issue) => (
            <li key={issue.id}>
              <a
                ...
                className="group grid min-h-8 min-w-0 touch-manipulation grid-cols-[minmax(0,1fr)_1.25rem] items-center gap-2 rounded-sm py-1.5 type-caption text-foreground hover:bg-surface-hover hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-focus"
              >
