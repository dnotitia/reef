...
export const AUTH_V2_LOGOUT_COOKIE = "__reef_auth_v2_logout";
...
export function buildAuthV2LogoutCookie(nonce: string): string {
  return buildCookie(AUTH_V2_LOGOUT_COOKIE, nonce, 60);
}

export function buildClearedAuthV2LogoutCookie(): string {
  return buildCookie(AUTH_V2_LOGOUT_COOKIE, "", 0);
}
