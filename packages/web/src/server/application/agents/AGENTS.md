...
- This tree is server-only. It owns the agent registry, runtime, prompts, use
  cases, and AI SDK tools. It may import `@reef/core` public schemas, models,
...
- Keep prompts, tool descriptors, runtime loops, and use cases separated under
  `framework/`, `prompts/`, `tools/`, and their feature modules.
