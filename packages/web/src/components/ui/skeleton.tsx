...
interface SkeletonProps extends React.HTMLAttributes<HTMLDivElement> {
   ...
   * actual fills live on `.reef-shimmer[data-tone]` in app/styles/motion.css.
   */
  tone?: SkeletonTone;
}

// `reef-shimmer` keyframe + two-tone fills are defined in app/styles/motion.css. To phase
