...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-full items-center justify-between gap-2 whitespace-nowrap rounded-md border border-border bg-surface-elevated px-2.5 py-1 type-control text-foreground transition-colors duration-150 hover:bg-surface-hover",
        ...
        "outline-none focus-visible:border-brand-focus focus-visible:ring-2 focus-visible:ring-brand-focus",
