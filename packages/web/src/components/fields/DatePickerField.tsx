        ...
        >
          ...
          <div className="mt-2 flex items-center justify-between border-t border-border-subtle pt-2">
            <button
              ...
              className="flex items-center gap-1.5 rounded-md px-2 py-1 type-caption font-medium text-brand-text transition-colors duration-150 hover:bg-surface-hover"
            >
              <span
            ...
            {normalized && clearable ? (
              <button
                type="button"
                onClick={handleClear}
                className="rounded-md px-2 py-1 type-caption text-muted-foreground transition-colors duration-150 hover:bg-surface-hover hover:text-foreground"
              >
                {t("clear")}
              </button>
            ) : null}
