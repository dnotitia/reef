import { SEVERITY_COLORS, SEVERITY_LABELS } from "@/components/fields/fieldKit";
 ...
 * the bare glyph from the labelled badge. Label + color live in one place
...
export function SeverityIcon({
  ...
  return (
    <Icon
      ...
      aria-label={
        decorative ? undefined : `Severity: ${SEVERITY_LABELS[severity]}`
      }
